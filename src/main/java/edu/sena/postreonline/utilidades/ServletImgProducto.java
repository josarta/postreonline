 ...
 * @author Josarta
 */
@WebServlet("/imagesProducto/*")
public class ServletImgProducto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!archivoNombre.isEmpty()) {
            String[] ruta = archivoNombre.split("/");
            File carpeta = new File("C:\\imgpostres\\Productos\\" + archivoNombre);
         ...
         try {
            ...
            System.out.println("edu.sena.postreonline.utilidades.ServletImg.doGet()" + e.getMessage());
        }
        }
